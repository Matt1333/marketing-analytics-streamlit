...
<style>
    ...
    [data-testid="stSidebar"] .row-widget label {
        color: #0f172a !important;      /* texte noir/gris foncé */
        font-weight: 500;
    }
    ...
    /* --------------------------------------------------------- */
/* 🔧 FORÇAGE DES INPUTS STREAMLIT EN MODE CLAIR             */
/* --------------------------------------------------------- */

/* Selectbox (pays, options) */
...
/* Le texte dans le select */
div[data-baseweb="select"] * {
    color: #0f172a !important;
}

/* Champ de saisie number_input */
input[type="number"] {
    background-color: #ffffff !important;
    color: #0f172a !important;
    border: 1px solid #d1d5db !important;
...
/* Les boutons + et - de number_input */
